...
Support commitments are written into the Coverbase agreement rather than left to goodwill. This page states them in plain terms so you can diligence them before you sign, and hold us to them afterwards.
...
<CardGroup cols={3}>
  ...
  <Card title="Your account team" icon="user-tie">
    Every customer has a named account contact. Enterprise customers additionally have a shared channel with the Coverbase team for day-to-day questions.
  </Card>
</CardGroup>
...
Escalation is automated, timed and independent of any chat tool, so a Slack outage cannot swallow a page.
