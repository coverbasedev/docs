...
<CardGroup cols={2}>
  ...
  <Card title="Self-serve setup" icon="sliders">
    An admin sets it up from **Configuration → Organization → Single Sign-On**: copy the ACS URL and SP entity ID into your IdP, paste your IdP metadata URL back, test the connection, activate. No support ticket, no professional services.
  </Card>
