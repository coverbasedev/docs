...
description: "How to read the Financial Health Score and External Security Intelligence cards in a vendor's Vendor Intelligence section, what each number claims, and what to do about what you find."
icon: "gauge-high"
---
...
Two cards in Vendor Intelligence carry a score rather than a description: **Coverbase Financial Health Score** and **External Security Intelligence**. Both are assembled without contacting the vendor: one from regulatory filings and registries, the other from the vendor's own public infrastructure.
