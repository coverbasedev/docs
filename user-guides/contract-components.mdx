...
<Steps>
  <Step title="Open the editor">
    On the contract's **Documents** tab, find the **What the documents say**
    card. Switch it to **By document**, find the document, and choose
    **Correct components**. The same button sits beside each source when you
    expand a component in the **By component** view.
  </Step>
  <Step title="Correct the list">
    Every component in the catalog is offered, and the ones the AI found are
    marked **Found by the AI**. Tick what the document carries, untick what it
    does not, and set an effective date where the document states one.
  </Step>
  <Step title="Save and re-read">
    **Save and re-read** re-reads the document. Because the corrected list also
    narrows what the extraction may believe, the figures it contributes can
    change.
  </Step>
</Steps>
