...
The review panel is the first thing on a result page, above the vendor profile. You can **approve** the run, **escalate** it to a full assessment, **archive** it, or **correct what it was built on**.
...
<AccordionGroup>
  ...
  <Accordion title="The profile describes the wrong company. Can I fix it?">
    Yes. Correct the vendor from the review panel — tell it the right name or website in your own words — then use **Re-source profile** on the result page. Re-scoring alone deliberately keeps the existing profile, so correcting identity is the step that refreshes it.
  </Accordion>
