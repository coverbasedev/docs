...
On the Clause Sets page open **Add Clause Set**, choose **Download Import Template**, fill in the **Clauses** sheet — one row per clause, rows sharing a **Clause Set** value grouped into one set — then come back and choose **Import from Spreadsheet**.
