...
<Frame caption="A signal. On the left, its status and the vendors exposed. On the right, the generated summary, the time from event to alert, and the detectors that put it in alert.">
