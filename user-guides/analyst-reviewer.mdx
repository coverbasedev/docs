...
3. Export the report. Use Standard PDF for most reviews, Executive Summary for leadership, or Full (every control with all evidence) when an examiner asks. Your organization's branded template fills itself in automatically.
