...
<Frame caption="One flagged clause in review. Severity, the matched variant and the AI analysis on the left, and the source language highlighted in the contract on the right.">
  <img src="/images/user-guides/analyst-contract-terms.png" alt="Clause review of a single clause with its analysis and the highlighted source language" />
</Frame>
...
<Frame caption="A signal. On the left, its status, the vendors exposed, and any reviews. On the right, the generated summary, Ask Coverbase AI, the time from event to alert, and the detectors that put the signal in alert.">
...
<Frame caption="The Cases tab. Preliminary investigations tagged to affected vendors, each with its status, progress and assignee, ready to close, promote to a finding, or trigger a reassessment.">
...
<Note>
  The full obligations workflow (validation, ownership, and business-unit acknowledgement) is in the [Obligations guide](/user-guides/obligations).
</Note>
