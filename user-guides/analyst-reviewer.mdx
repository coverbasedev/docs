...
5. Dismiss what does not matter. Tick **Also dismiss future similar alerts** and the detectors that fired learn from it, so the next event like it stays quiet.
