...
Five tabs in every vendor's Vendor Intelligence section, each assembled without contacting the vendor, and each designed to be checked rather than trusted.
...
<Card title="Sanctions screening guide" icon="scale-balanced" href="/user-guides/sanctions-screening">
  Whether the vendor or its people appear on a sanctions, watchlist, criminal or legal source — re-checked on a schedule rather than once at onboarding. Why the confidence score measures identity and not severity, how to clear a false positive, and why every clear screen is recorded too.
</Card>

<Card title="Financial health and security intelligence guide" icon="gauge-high" href="/user-guides/vendor-fact-sheet">
  The older combined walkthrough, covering the Financial Health Score and Security Posture cards as they appear on the fact sheet.
</Card>

## Continuous monitoring

Radar watches your vendors between assessments. If you already subscribe to a
ratings service, you can feed its findings into the same alert stream.
...
A lightweight triage run assembled entirely from open-source research, with no outreach. The product page behind it is [Zero Touch Assessments](/products/zero-touch-assessments).

<Card title="Zero Touch Assessment guide" icon="bolt" href="/user-guides/zero-touch-assessments">
  How to run one across a portfolio, how to read the composite and the components behind it, how to correct a run that bound the wrong company, and what the audit trail records.
</Card>
...
Start with the workspace guide to learn the screens. Contract intelligence itself has two halves, set up separately; read both if you own the contracts module.

<CardGroup cols={2}>
  <Card title="Contracts workspace" icon="folder-open" href="/user-guides/contracts-workspace">
    The screens you work in every day: the key statistics row, the renewal runway and how to collapse or hide it, and the cards on a contract record including how to add and remove fields on the details card.
  </Card>
