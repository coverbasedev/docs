...
Two cards on every vendor fact sheet carry a score rather than a description. Both are assembled without contacting the vendor, and both are designed to be checked rather than trusted.
