...
<Info>
  Welcome. This is a shareable home for Coverbase's getting-started guides. It doesn't show up in the main documentation navigation, so anyone you send the link to can read it, and you can bookmark it for your team. We'll add more here over time (Radar, contracts, and the rest).
</Info>
...
<Steps>
  ...
  <Step title="Run the work (analyst and reviewer)">
    Triage requests, launch assessments, review and correct AI findings, follow up with vendors, and disposition results. Follow the [Analyst and reviewer guide](/user-guides/analyst-reviewer).
  </Step>
