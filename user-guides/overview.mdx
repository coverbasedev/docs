...
<Card title="Black Kite monitoring guide" icon="shield-halved" href="/user-guides/black-kite-monitoring">
  How to connect your Black Kite portfolio, choose which vendors are watched, and turn known exploited vulnerabilities and focus tags into alerts. Includes the two settings that decide whether monitoring keeps up with a large portfolio, and why a source on its own never raises anything.
</Card>
