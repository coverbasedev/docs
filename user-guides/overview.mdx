...
<CardGroup cols={2}>
  ...
  <Card title="Clause set spreadsheet import" icon="file-import" href="/user-guides/clause-set-spreadsheet-import">
    Already have your clause playbook in a spreadsheet? The workbook format, every column explained, and what happens when you re-upload a file.
  </Card>
</CardGroup>
