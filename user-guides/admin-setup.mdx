...
Radar is the external intelligence layer. Sources feed detectors, detectors raise alerts, and alerts roll up into one signal per event for your analysts to work. Sources and detectors both live under **Radar → Configuration**.
...
<Frame caption="Radar detectors, under Configuration. Each one is scoped to what you'll act on, with categories, reviewers, and an enable toggle.">
  <img src="/images/user-guides/admin-radar-detectors.png" alt="Radar detector configuration list" />
</Frame>

<Frame caption="Radar sources, under Configuration. Built-in feeds plus any public RSS feed or connected ratings API.">
