...
Radar is the external intelligence layer. Sources feed detectors, detectors raise alerts, and alerts roll up into one signal per event for your analysts to work. Sources and detectors live under **Configuration → Radar**. The **Configurations** button on the Radar page takes you there.
