...
description: "The 12 packaged clause standards Coverbase ships: what each one covers, how many clauses it carries, how to pick the right starting point, and what changes when you copy one."
icon: "book-open"
---
...
<Note>
  The library also lists ten older, smaller sets from before these templates, such as **SaaS Vendor Risk Clause Set** (15 clauses) and **Agreement Metadata Clause Set** (4 clauses). They show the category **generic**, and all but the SaaS set carry a single tier of language. This page covers the 12 templates above.
</Note>
...
On **Configuration → Clause Sets**, open the **Add Clause Set** menu and choose **Clause Set Library**. Search or filter by category, pick a template, and choose **Create Clause Set**. The copy takes the template's name and is active straight away.
