...
| --- | --- | --- |
| `benefitfocus.com` | `benefitfocus.com` | Yes |
| `benefitfocus.com` | `https://www.benefitfocus.com/careers` | Yes |
| `mail.benefitfocus.com` | `benefitfocus.com` | Yes. The parent is tried after the exact host. |
| `benefitfocus.com` | `app.benefitfocus.com` | **No.** Step 3 only ever climbs, never descends. |
| `bhmpc.com` | `bhmpc.co.uk` | **No.** Different domain. |
| `betsol.com` | (no website recorded) | **No.** Nothing to compare. |
