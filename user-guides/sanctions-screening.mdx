...
<Frame caption="The policy: which sources, who gets screened, and which vendor tiers are monitored.">
  <img src="/images/user-guides/screening-settings.png" alt="The screening settings page showing the connection status, source toggles, adverse media categories, subject selection, and the monitoring table by vendor tier." />
</Frame>
...
<Frame caption="Monitoring is per vendor tier. The profile group is optional.">
  <img src="/images/user-guides/screening-monitoring.png" alt="The monitoring table listing each vendor tier with a monitored switch and an optional provider profile group." />
</Frame>

Tier 4 and untiered vendors are unmonitored by default, so switching screening on does not silently enrol your entire long tail - a monitored vendor is a standing subscription, not a one-off charge.
