...
<Frame caption="The review drawer: what matched, field by field, with the sources behind it.">
  <img src="/images/user-guides/screening-match-review.png" alt="The match review drawer showing the screened subject, the flagged source, country, registration number, aliases, programs, a field-level match breakdown, and the source listing." />
</Frame>
