...
sources, and between them they cover all fifty states. Every one is checked against the live site before it ships: a source
...
| Massachusetts | Reporting organization, residents affected, and whether the data was encrypted |
| New Hampshire | The notice letters themselves |
...
Twelve states publish a register of their own, listed above. The rest are
