...
<CardGroup cols={2}>
  ...
  <Card title="Permission inheritance" icon="user-shield">
...
Report any security issue to [security@coverbase.com](mailto:security@coverbase.com). We acknowledge reports within one business day and follow responsible-disclosure timelines.
