...
- **Auth**: OAuth 2.0 + PKCE
- **Tools**: All 12 dispatcher tools (vendor / assessment / finding / engagement / control / questionnaire / RFP / radar / platform queries, the `get_report` aggregations, the `mutate` write dispatcher, and `mcp_capabilities` discovery)
- **Resources**: Direct URI reads for vendors, assessments, engagements, controls, and findings
- **Prompts**: TPRM workflow templates (vendor onboarding, portfolio risk briefing, and more)
