...
<AccordionGroup>
  ...
  <Accordion title="Assessment review prep" icon="clipboard-check">
    > Summarize assessment cbqsrw\_abc123 and list the controls that need human review.
  ...
  <Accordion title="The whole written report, not the preview" icon="file-lines">
  ...
  <Accordion title="Outcomes and residual risk across the portfolio" icon="table-columns">
    > List every completed assessment this quarter with its outcome and residual risk level, as a table.

    Both fields are on each `query_assessments(kind="search")` row, so this is one call per page rather than one call per assessment. See [Replacing the assessment export](/mcp/assessment-exports) if you are feeding a dashboard.
  </Accordion>

  <Accordion title="Why was this one conditionally approved?" icon="circle-half-stroke">
...
Coverbase reads the documents and returns the passage the answer rests on. Full guide: [Asking your documents a question](/user-guides/document-evidence-pull).

<AccordionGroup>
  <Accordion title="Answer a control question from the SOC 2" defaultOpen icon="file-magnifying-glass">
  ...
  <Accordion title="Pull a contract term with its exact wording" icon="file-contract">
  ...
  <Accordion title="Check one specific document" icon="file">
  ...
  <Accordion title="Evidence for an assessment answer" icon="clipboard-check">
  ...
  <Accordion title="When nothing answers the question" icon="circle-minus">
...
<AccordionGroup>
  ...
  <Accordion title="What should I raise with a vendor about their security?" icon="shield-halved">
...
<AccordionGroup>
  ...
  <Accordion title="Create a finding on an assessment" icon="flag">
    > Create a finding on assessment cbqsrw\_abc123 titled "Missing encryption at rest evidence" and assign it to me.
...
<AccordionGroup>
  ...
  <Accordion title="Clear false positives on one assessment" icon="check-double">
    > Go through the flagged issues on assessment cbqsrw\_abc123 with me and clear the ones that aren't real.
...
<CardGroup cols={2}>
  ...
  <Card title="Replacing the assessment export" icon="table-columns" href="/mcp/assessment-exports">
