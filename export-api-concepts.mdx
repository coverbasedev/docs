...
<Frame>
  ![Creating a new export report in the Coverbase dashboard](/images/export-api-setup.png)
</Frame>
...
<AccordionGroup>
  ...
  <Accordion title="Evaluation" icon="circle-check">
  ...
  <Accordion title="Control" icon="shield-check">
  ...
  <Accordion title="Control Set" icon="folder-tree">
...
<Card title="Export API Reference" icon="code" href="/export-api/reference">
  Endpoint signatures, request parameters, full response schemas, and code samples.
</Card>