---
title: "Slack"
description: "Coverbase's Slack app delivers work notifications where your team already lives, matched to the right person and resilient to Slack's rate limits."
icon: "slack"
---
...
Coverbase ships a Slack app that installs into your workspace and delivers notifications where your team already works: an analyst learns an intake draft is ready, a reviewer learns an assessment reached their queue, an owner learns a finding was assigned. It arrives as a Slack message, not another unread email.
