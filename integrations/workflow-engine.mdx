...
- By default the event type is the workflow's triggering event; an optional **event type override** changes which subscriptions are matched and the type the delivery is labelled with.
