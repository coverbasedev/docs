...
<Frame>
  ![Creating a new import report in the Coverbase dashboard](/images/import-api-setup.png)
</Frame>
...
<AccordionGroup>
  <Accordion title="Vendor" defaultOpen icon="building">
  ...
  <Accordion title="Assessment" icon="clipboard-list">
...
<Card title="Import API Reference" icon="code" href="/import-api/reference">
  Full endpoint signature, request body schema, response fields, and error codes.
</Card>