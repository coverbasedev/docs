...
Admins can list, create, rotate, and revoke `ak_*` keys self-service via the [API Keys API](/integrations/api-reference/api-keys) — no support ticket required.
...
| Scope | Grants |
| ----- | ------ |
| `keys:manage` | List, create, rotate, and revoke `ak_*` keys via the [API Keys API](/integrations/api-reference/api-keys). |
