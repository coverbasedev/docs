...
<CardGroup cols={2}>
  ...
  <Card title="Every answer cites its source" icon="quote-left">
    Each resolved term names the document, the page and the effective date it came from: "Net 60, from Amendment 3 effective 1 Jan 2024, supersedes Net 30 in the master agreement." The provenance is the answer, not a footnote to it.
  </Card>
</CardGroup>
