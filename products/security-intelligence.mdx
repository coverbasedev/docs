...
| Network exposure | 14% | Exposed services and administrative interfaces |
| Email authentication | 12% | SPF, DMARC, DKIM, MTA-STS, measured as policy |
...
| Leaked credentials | 8% | Credentials exposed in known breaches |
| IP reputation | 7% | Malicious activity attributed to the vendor's addresses |
| TLS assessment | 6% | The SSL Labs grade for the vendor's site, and any configuration warnings |
