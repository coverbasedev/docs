...
<CardGroup cols={2}>
  ...
  <Card title="On demand" icon="arrows-rotate">
    Re-extract a whole document or a single insight after you add or reword a definition. New definitions do not backfill documents already processed.
  </Card>
...
<Note>
  Insight values surface on the document, on the contract record, in the contract AI summary, and through the [MCP server](/mcp/overview) for natural-language querying.
</Note>
