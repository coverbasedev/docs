...
<CardGroup cols={2}>
  ...
  <Card title="Intake API" icon="code" href="/api-reference/intake">
    The endpoint reference: create sessions, pass unstructured context, poll for the auto-answered questionnaire.
  </Card>

  <Card title="Intake in chat" icon="comments" href="/mcp/vendor-intake">
    Run the whole request conversationally through the MCP server. Same session, same review queue.
  </Card>
</CardGroup>
...
<AccordionGroup>
  <Accordion title="Conversational intake" icon="comments">
