...
<CardGroup cols={2}>
  ...
  <Card title="Risk classification" icon="layer-group">
...
| Pre-qualification | Whether financial, security, and sanctions screening runs. |
...
<AccordionGroup>
  ...
  <Accordion title="Procurement system embedding" icon="puzzle-piece">
    Call the [Intake API](/api-reference/intake) from your procurement or ticketing system. When a requester opens a new vendor request there, the request's free-form context becomes an intake session, and Intake researches the vendor and drafts the questionnaire before a reviewer sees it.
  </Accordion>
