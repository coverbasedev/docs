...
<Steps>
  ...
  <Step title="Analyse">
    One pass reads every document together, because a statement set only makes sense as a set. It takes a few minutes; the tab shows progress and says plainly if a document could not be read.
  </Step>
</Steps>
