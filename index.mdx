...
<CardGroup cols={3}>
  ...
  <Card title="Import API" icon="arrow-down-to-bracket" href="/import-api/concepts">
...
<CardGroup cols={2}>
  ...
  <Card title="Coverbase Inspect" icon="magnifying-glass" href="/products/inspect">
...
<CardGroup cols={3}>
  <Card title="Product support" icon="envelope" href="mailto:support@coverbase.ai">
    [support@coverbase.com](mailto:support@coverbase.com)
  </Card>

  <Card title="Security issues" icon="shield-halved" href="mailto:security@coverbase.ai">
    [security@coverbase.com](mailto:security@coverbase.com)
  </Card>
