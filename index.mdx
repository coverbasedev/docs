...
<CardGroup cols={3}>
  <Card title="Vendors" icon="building" href="/user-guides/vendor-record">
    The vendor record, services and engagements, subprocessors, and supplier bank and tax details with a country reference.
  </Card>
  ...
  <Card title="Monitoring and risk" icon="satellite-dish" href="/user-guides/radar-signals">
    Working Radar signals, feeding in a Black Kite portfolio, the risk register, and the supplier geography map.
  </Card>
