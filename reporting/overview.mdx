...
<CardGroup cols={2}>
  ...
  <Card title="Standard assessment exports" icon="file-pdf">
    PDF and Excel exports of an assessment. Fixed layout, no template required. Toggle sections such as findings, reviews, follow-ups, notes, and the activity log at export time.
  </Card>
...
| A complete record of everything in an assessment, including evidence snippets and the activity log | Standard PDF export |
| Assessment results in a spreadsheet for filtering or pivoting | Standard Excel export |
