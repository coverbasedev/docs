...
Two sections carry outside-in intelligence assembled from registries of record rather than from a language model. Both cite their sources. See [Vendor Intelligence](/products/vendor-intelligence) for what each field means.
