...
| 403 | `{"detail": "Findings are not enabled for this organization."}` | A vendor-level finding (`vendor_id`) was requested and your organization does not have the **Findings** page enabled. Findings on an assessment are always allowed. |
